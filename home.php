...
@$result_pesquisa = "SELECT * FROM criacao_user  WHERE status LIKE 'Pendente'  LIMIT 1000 ";
...
<!--PAINEL HOME DESLIGAMENTO INCIO-->
          <?php
    				...
    				@	$pesquisar_s = $_POST ['pesquisar_s'];
    				@$responsavel = $_POST ['responsavel'];
            @$result_pesquisa = "SELECT * FROM desligamento_user  WHERE  status_1 LIKE 'Pendente'  LIMIT 1000 ";
    				$resultado_pesqeuisa = mysqli_query($conn, $result_pesquisa);
    			?>
    		</form>
    	<!--	<div class="container theme-showcase" role="main">  -->
...
<?php
  ...
  @$pesquisar = $_POST ['pesquisar'];
  @$pesquisar_s = $_POST ['pesquisar_s'];
  @$result_pesquisa = "SELECT * FROM bloqueio_user  WHERE responsavel ='' AND status_1 LIKE 'Pendente'  LIMIT 1000 ";
  $resultado_pesqeuisa = mysqli_query($conn, $result_pesquisa);
  ?>
</form>
<!--	<div class="container theme-showcase" role="main">  -->
...
<?php
  ...
  @$pesquisar = $_POST ['pesquisar'];
  @$pesquisar_s = $_POST ['pesquisar_s'];
  @$result_pesquisa = "SELECT * FROM alteracao_user  WHERE  status LIKE 'Pendente'  LIMIT 1000 ";
  $resultado_pesqeuisa = mysqli_query($conn, $result_pesquisa);
  ?>
</form>
<!--	<div class="container theme-showcase" role="main">  -->
