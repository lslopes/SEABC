...
<div class="container theme-showcase" role="main">
  <div class="page-header">
    <h3>Registro Bolqueios</h3>
  </div>
</div>
		<form action="insert_bloqueios.php"><!--Formulario de Bloqueios-->
						<div class="col-md-2">
            ...
            <div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" name="email_p" class="form-control"  placeholder="E-mail Pessoal"><br><br>
							</div>
						</div>
            <div class="col-md-2">
							<div class="form-group">
								<label>Data de Bloqueio</label>
								<input type="date" name="databloqueio" class="form-control"  placeholder="Data de Bloqueio"><br><br>
							</div>
						</div>
            <div class="col-md-2">
							<div class="form-group">
            ...
            <div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" name="responsavel" class="form-control"  placeholder="Responsavel"><br><br>
							</div>
						</div>
						<br>
          ...
          <div class="container theme-showcase" role="main">
            <div class="page-header">
             		...
             		<form method="POST" action="formulario_bloqueios.php">
             			<br>
             		...
             		<style>
             			...
             			<div class="row">
                            ...
                            <th>Acoes</th>
                              ...
                              <td><form action="solicitacao_bloqueios.php">
