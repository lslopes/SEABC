		...
		<form action="insert_criacao.php"><!--Formulario de Criação-->
            ...
            <div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" name="email_p" class="form-control"  placeholder="E-mail"><br><br>
							</div>
						</div>
            <div class="col-md-2">
							<div class="form-group">
								<label>Data da Alteração</label>
								<input type="date" name="data_alteraca" class="form-control"  placeholder="Data de Criação"><br><br>
							</div>
						</div>
            <div class="col-md-2">
							<div class="form-group">
            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <input type="text" name="alterado_de" class="form-control"  placeholder="Responsavel"><br><br>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <label>Altera Para</label>
                <input type="text" name="alterado_para" class="form-control"  placeholder="Responsavel"><br><br>
              </div>
            </div>
						<br>
          ...
          <div class="container theme-showcase" role="main">
            <div class="page-header">
             		...
             		<form method="POST" action="formulario_alteracoes.php">
             			<br>
             		...
             		<style>
             			...
             			<div class="row">
                            ...
                            <th>Acoes</th>
                              ...
                              <td><form action="solicitacao_alteracoa.php">
