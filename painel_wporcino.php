...
@$result_pesquisa = "SELECT * FROM criacao_user  WHERE responsavel ='Wladimir Porcino' AND status LIKE 'Pendente'  LIMIT 1000 ";
...
<!--PAINEL HOME DESLIGAMENTO INCIO-->
          <?php
    				...
    				@	$pesquisar_s = $_POST ['pesquisar_s'];
    				@$responsavel = $_POST ['responsavel'];
            @$result_pesquisa = "SELECT * FROM desligamento_user  WHERE responsavel ='Wladimir Porcino' AND status LIKE 'Pendente'  LIMIT 1000 ";
    				$resultado_pesqeuisa = mysqli_query($conn, $result_pesquisa);
    			?>
    		</form>
    	<!--	<div class="container theme-showcase" role="main">  -->
...
<?php
  ...
  @$pesquisar = $_POST ['pesquisar'];
  @$pesquisar_s = $_POST ['pesquisar_s'];
  @$result_pesquisa = "SELECT * FROM bloqueio_user  WHERE responsavel ='Wladimir Porcino' AND status LIKE 'Pendente'  LIMIT 1000 ";
  $resultado_pesqeuisa = mysqli_query($conn, $result_pesquisa);
  ?>
</form>
<!--	<div class="container theme-showcase" role="main">  -->
...
<?php
  ...
  @$pesquisar = $_POST ['pesquisar'];
  @$pesquisar_s = $_POST ['pesquisar_s'];
  @$result_pesquisa = "SELECT * FROM alteracao_user  WHERE responsavel ='Wladimir Porcino' AND status LIKE 'Pendente'  LIMIT 1000 ";
  $resultado_pesqeuisa = mysqli_query($conn, $result_pesquisa);
  ?>
</form>
<!--	<div class="container theme-showcase" role="main">  -->
